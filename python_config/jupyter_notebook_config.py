...
c.NotebookApp.certfile = os.path.expanduser('~/.jupyter/cert_keys/fullchain.pem')
...
c.NotebookApp.keyfile = os.path.expanduser('~/.jupyter/cert_keys/privkey.pem')
